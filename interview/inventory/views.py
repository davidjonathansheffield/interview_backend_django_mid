...
class InventoryListCreateView(APIView):
    ...
    def _get_paginated_response(self, data):
        """
        Optionally, this could also be abstracted into its own file called pagination to apply this to different models
        rather than just Inventory.  Or onto a base class that all views that wish to paginate can inherit from.  This
        seems like overkill at the current moment to efficiently tackle this task (and the rest in the time limit) but
        it is a great option moving forward in a real world scenario.
        """
